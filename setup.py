...
setup(name='trytond_account_plus_ec',
    ...
    package_dir={'trytond.modules.account_plus_ec': '.'},
    packages=[
        'trytond.modules.account_plus_ec',
    ],
    package_data={
    ...
    entry_points="""
    [trytond.modules]
    account_plus_ec = trytond.modules.account_plus_ec
    """,
    )
